...
public class Infanteria implements IBatallones, IColeccionInfanteria{
    ...
    private ArrayList<ItropaConArma> unidadElemento;
    public Infanteria() {
    ...
    @Override
    public void add(ItropaConArma elemento) {
    ...
    public ArrayList<ItropaConArma> getUnidadElemento() {
